...
class FeedBack {
    ...
    createFeedback(reviewText, selectedScore) {
...
function renderScore() {
    ...
    let listScore = document.querySelector("#list-score");
    listScore.innerHTML = '';
...
renderScore();
const scoreRates = document.querySelectorAll('.score-rate');
let selectedScore = 0;
